...
// LookupHostBatchPostOpts Optional parameters for the method 'LookupHostBatchPost'
type LookupHostBatchPostOpts struct {
    ContentEncoding optional.String
}

/*
LookupHostBatchPost lookup batch for list of host entities, given their fingerprints
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param userAgent
 * @param xLicenseKey
 * @param lookupHostRequest
 * @param optional nil or *LookupHostBatchPostOpts - Optional Parameters:
 * @param "ContentEncoding" (optional.String) - 
@return []map[string]interface{}
*/
func (a *DefaultApiService) LookupHostBatchPost(ctx _context.Context, userAgent string, xLicenseKey string, lookupHostRequest []LookupHostRequest, localVarOptionals *LookupHostBatchPostOpts) ([]map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/lookup_host/batch"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	if len(lookupHostRequest) < 1 {
		return localVarReturnValue, nil, reportError("lookupHostRequest must have at least 1 elements")
	}
	if len(lookupHostRequest) > 1000 {
		return localVarReturnValue, nil, reportError("lookupHostRequest must have less than 1000 elements")
	}
	...
	localVarHeaderParams["X-License-Key"] = parameterToString(xLicenseKey, "")
	// body params
	localVarPostBody = &lookupHostRequest
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
// LookupHostPostOpts Optional parameters for the method 'LookupHostPost'
type LookupHostPostOpts struct {
    ContentEncoding optional.String
}

/*
LookupHostPost lookup for a host entity, given the fingerprint
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param userAgent
 * @param xLicenseKey
 * @param lookupHostRequest
 * @param optional nil or *LookupHostPostOpts - Optional Parameters:
 * @param "ContentEncoding" (optional.String) - 
@return LookupHostResponse
*/
func (a *DefaultApiService) LookupHostPost(ctx _context.Context, userAgent string, xLicenseKey string, lookupHostRequest LookupHostRequest, localVarOptionals *LookupHostPostOpts) (LookupHostResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  LookupHostResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/lookup_host"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
